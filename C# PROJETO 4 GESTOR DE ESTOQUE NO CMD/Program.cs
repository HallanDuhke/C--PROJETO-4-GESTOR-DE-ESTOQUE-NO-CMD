using C__PROJETO_4_GESTOR_DE_ESTOQUE_NO_CMD;
using System;
...
namespace C__PROJETO_4_GESTOR_DE_ESTOQUE_NO_CMD
{
    class Program
    {
        ...
        enum ProdutosTipos { ProdutoFisico = 1, Ebook, Curso }
...

        {
            ...
            string opStr = Console.ReadLine();
            int produtoInt = int.Parse(opStr);

            ProdutosTipos escolhaProduto = (ProdutosTipos)produtoInt;
            switch (escolhaProduto)
            {

                case ProdutosTipos.ProdutoFisico:
                    CadastroPFisico();
                    break;
                case ProdutosTipos.Ebook:
                    CadastrarEbook();
                    break;
                case ProdutosTipos.Curso:
                    CadastrarCurso();
                    break;
